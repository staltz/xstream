...
_stop:d})};a.throw=function(b){return new a({_start:function(a){a._e(b)},_stop:d})};a.from=function(b){if("function"===typeof b[t.default])return a.fromObservable(b);if("function"===typeof b.then)return a.fromPromise(b);if(Array.isArray(b))return a.fromArray(b);throw new TypeError("Type of input to from() must be an Array, Promise, or Observable");};a.of=function(){for(var b=[],c=0;c<arguments.length;c++)b[c]=arguments[c];return a.fromArray(b)};a.fromArray=function(b){return new a(new D(b))};a.fromPromise=
function(b){return new a(new E(b))};a.fromObservable=function(b){if(b.endWhen)return b;b="function"===typeof b[t.default]?b[t.default]():b;return new a(new z(b))};a.periodic=function(b){return new a(new F(b))};a.prototype._map=function(b){return new (this.ctor())(new O(b,this))};a.prototype.map=function(b){return this._map(b)};a.prototype.mapTo=function(b){var a=this.map(function(){return b});a._prod.type="mapTo";return a};a.prototype.filter=function(b){var c=this._prod;return c instanceof v?new a(new v(u(c.f,
b),c.ins)):new a(new v(b,this))};a.prototype.take=function(b){return new (this.ctor())(new S(b,this))};a.prototype.drop=function(b){return new a(new H(b,this))};a.prototype.last=function(){return new a(new N(this))};a.prototype.startWith=function(b){return new q(new R(this,b))};a.prototype.endWhen=function(b){return new (this.ctor())(new J(b,this))};a.prototype.fold=function(b,a){return new q(new M(b,a,this))};a.prototype.replaceError=function(a){return new (this.ctor())(new Q(a,this))};a.prototype.flatten=
function(){return new a(new L(this))};a.prototype.compose=function(a){return a(this)};a.prototype.remember=function(){return new q(new P(this))};a.prototype.debug=function(a){return new (this.ctor())(new G(this,a))};a.prototype.imitate=function(a){if(a instanceof q)throw Error("A MemoryStream was given to imitate(), but it only supports a Stream. Read more about this restriction here: https://github.com/staltz/xstream#faq");this._target=a;for(var b=this._ils,c=b.length,d=0;d<c;d++)a._add(b[d]);this._ils=
[]};a.prototype.shamefullySendNext=function(a){this._n(a)};a.prototype.shamefullySendError=function(a){this._e(a)};a.prototype.shamefullySendComplete=function(){this._c()};a.prototype.setDebugListener=function(a){a?(this._d=!0,a._n=a.next||d,a._e=a.error||d,a._c=a.complete||d,this._dl=a):(this._d=!1,this._dl=c)};a.merge=function(){for(var b=[],c=0;c<arguments.length;c++)b[c]=arguments[c];return new a(new A(b))};a.combine=function(){for(var b=[],c=0;c<arguments.length;c++)b[c]=arguments[c];return new a(new C(b))};
return a}();h.Stream=f;var q=function(a){function b(b){b=a.call(this,b)||this;b._has=!1;return b}m(b,a);b.prototype._n=function(b){this._v=b;this._has=!0;a.prototype._n.call(this,b)};b.prototype._add=function(a){var b=this._target;if(b!==c)return b._add(a);b=this._ils;b.push(a);1<b.length?this._has&&a._n(this._v):this._stopID!==c?(this._has&&a._n(this._v),clearTimeout(this._stopID),this._stopID=c):this._has?a._n(this._v):(a=this._prod,a!==c&&a._start(this))};b.prototype._stopNow=function(){this._has=
...
function(b){return a.prototype.debug.call(this,b)};return b}(f);h.MemoryStream=q;h.default=f},{"symbol-observable":2}],2:[function(f,k,h){var d="undefined"!==typeof global?global:"undefined"!==typeof self?self:"undefined"!==typeof window?window:{};Object.defineProperty(h,"__esModule",{value:!0});f=(f=f("./ponyfill.js"))&&f.__esModule?f:{"default":f};k="undefined"!==typeof self?self:"undefined"!==typeof window?window:"undefined"!==typeof d?d:"undefined"!==typeof k?k:Function("return this")();k=(0,
f["default"])(k);h["default"]=k},{"./ponyfill.js":3}],3:[function(f,k,h){Object.defineProperty(h,"__esModule",{value:!0});h["default"]=function(d){var f=d.Symbol;"function"===typeof f?f.observable?d=f.observable:(d=f("observable"),f.observable=d):d="@@observable";return d}},{}]},{},[1])(1)});