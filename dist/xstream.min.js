...
b!==c&&(this.open||this.inner!==c||b._c())};a.prototype._n=function(b){var a=this.out;if(a!==c){var g=this.inner,d=this.il;g!==c&&d!==r&&g._remove(d);(this.inner=b)._add(this.il=new M(a,this))}};a.prototype._e=function(b){var a=this.out;a!==c&&a._e(b)};a.prototype._c=function(){this.open=!1;this.less()};return a}(),O=function(){function a(b,a,g){var f=this;this.type="fold";this.ins=g;this.out=c;this.f=function(a){return b(f.acc,a)};this.acc=this.seed=a}a.prototype._start=function(b){this.out=b;this.acc=
...
a.prototype.setDebugListener=function(a){a?(this._d=!0,a._n=a.next||d,a._e=a.error||d,a._c=a.complete||d,this._dl=a):(this._d=!1,this._dl=c)};a.merge=function(){for(var b=[],c=0;c<arguments.length;c++)b[c]=arguments[c];return new a(new B(b))};a.combine=function(){for(var b=[],c=0;c<arguments.length;c++)b[c]=arguments[c];return new a(new E(b))};return a}();h.Stream=e;var p=function(a){function b(b){b=a.call(this,b)||this;b._has=!1;return b}m(b,a);b.prototype._n=function(b){this._v=b;this._has=!0;a.prototype._n.call(this,
