(function(u){"object"===typeof exports&&"undefined"!==typeof module?module.exports=u():"function"===typeof define&&define.amd?define([],u):("undefined"!==typeof window?window:"undefined"!==typeof global?global:"undefined"!==typeof self?self:this).xstream=u()})(function(){return function d(g,k,h){function q(l,m){if(!k[l]){if(!g[l]){var n="function"==typeof require&&require;if(!m&&n)return n(l,!0);if(t)return t(l,!0);m=Error("Cannot find module '"+l+"'");throw m.code="MODULE_NOT_FOUND",m;}m=k[l]={exports:{}};
g[l][0].call(m.exports,function(c){var d=g[l][1][c];return q(d?d:c)},m,m.exports,d,g,k,h)}return k[l].exports}for(var t="function"==typeof require&&require,n=0;n<h.length;n++)q(h[n]);return q}({1:[function(g,k,h){function d(){}function q(a){for(var b=a.length,e=Array(b),c=0;c<b;++c)e[c]=a[c];return e}function t(a,b){return function(e){return a(e)&&b(e)}}function n(a,b,e){try{return a.f(b)}catch(f){return e._e(f),c}}function l(a){a._start=function(b){b.next=b._n;b.error=b._e;b.complete=b._c;this.start(b)};
a._stop=a.stop}var m=this&&this.__extends||function(){var a=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(b,e){b.__proto__=e}||function(b,e){for(var a in e)e.hasOwnProperty(a)&&(b[a]=e[a])};return function(b,e){function c(){this.constructor=b}a(b,e);b.prototype=null===e?Object.create(e):(c.prototype=e.prototype,new c)}}();Object.defineProperty(h,"__esModule",{value:!0});var w=g("symbol-observable"),c={};h.NO=c;var r={_n:d,_e:d,_c:d};h.NO_IL=r;var y=function(){function a(b,e){this._stream=
b;this._listener=e}a.prototype.unsubscribe=function(){this._stream.removeListener(this._listener)};return a}(),z=function(){function a(b){this._listener=b}a.prototype.next=function(b){this._listener._n(b)};a.prototype.error=function(b){this._listener._e(b)};a.prototype.complete=function(){this._listener._c()};return a}(),A=function(){function a(b){this.type="fromObservable";this.ins=b;this.active=!1}a.prototype._start=function(b){this.out=b;this.active=!0;this._sub=this.ins.subscribe(new z(b));this.active||
...
function(b){this.out=b;this.ins._add(this)};a.prototype._stop=function(){this.ins._remove(this);this.out=c};a.prototype._n=function(b){var a=this.out;if(a!==c){var f=this.s,g=this.l;if(f!==d)try{f(b)}catch(C){a._e(C)}else g?console.log(g+":",b):console.log(b);a._n(b)}};a.prototype._e=function(b){var a=this.out;a!==c&&a._e(b)};a.prototype._c=function(){var b=this.out;b!==c&&b._c()};return a}(),J=function(){function a(b,a){this.type="drop";this.ins=a;this.out=c;this.max=b;this.dropped=0}a.prototype._start=
...
return new y(this,b)};a.prototype[w.default]=function(){return this};a.create=function(b){if(b){if("function"!==typeof b.start||"function"!==typeof b.stop)throw Error("producer requires both start and stop functions");l(b)}return new a(b)};a.createWithMemory=function(b){b&&l(b);return new p(b)};a.never=function(){return new a({_start:d,_stop:d})};a.empty=function(){return new a({_start:function(b){b._c()},_stop:d})};a.throw=function(b){return new a({_start:function(a){a._e(b)},_stop:d})};a.from=function(b){if("function"===
typeof b[w.default])return a.fromObservable(b);if("function"===typeof b.then)return a.fromPromise(b);if(Array.isArray(b))return a.fromArray(b);throw new TypeError("Type of input to from() must be an Array, Promise, or Observable");};a.of=function(){for(var b=[],c=0;c<arguments.length;c++)b[c]=arguments[c];return a.fromArray(b)};a.fromArray=function(b){return new a(new F(b))};a.fromPromise=function(b){return new a(new G(b))};a.fromObservable=function(b){return b.endWhen?b:new a(new A(b))};a.periodic=
function(b){return new a(new H(b))};a.prototype._map=function(b){return new (this.ctor())(new Q(b,this))};a.prototype.map=function(b){return this._map(b)};a.prototype.mapTo=function(b){var a=this.map(function(){return b});a._prod.type="mapTo";return a};a.prototype.filter=function(b){var c=this._prod;return c instanceof v?new a(new v(t(c.f,b),c.ins)):new a(new v(b,this))};a.prototype.take=function(a){return new (this.ctor())(new U(a,this))};a.prototype.drop=function(b){return new a(new J(b,this))};
a.prototype.last=function(){return new a(new P(this))};a.prototype.startWith=function(a){return new p(new T(this,a))};a.prototype.endWhen=function(a){return new (this.ctor())(new L(a,this))};a.prototype.fold=function(a,c){return new p(new O(a,c,this))};a.prototype.replaceError=function(a){return new (this.ctor())(new S(a,this))};a.prototype.flatten=function(){return new a(new N(this))};a.prototype.compose=function(a){return a(this)};a.prototype.remember=function(){return new p(new R(this))};a.prototype.debug=
function(a){return new (this.ctor())(new I(this,a))};a.prototype.imitate=function(a){if(a instanceof p)throw Error("A MemoryStream was given to imitate(), but it only supports a Stream. Read more about this restriction here: https://github.com/staltz/xstream#faq");this._target=a;for(var b=this._ils,c=b.length,d=0;d<c;d++)a._add(b[d]);this._ils=[]};a.prototype.shamefullySendNext=function(a){this._n(a)};a.prototype.shamefullySendError=function(a){this._e(a)};a.prototype.shamefullySendComplete=function(){this._c()};
a.prototype.setDebugListener=function(a){a?(this._d=!0,a._n=a.next||d,a._e=a.error||d,a._c=a.complete||d,this._dl=a):(this._d=!1,this._dl=c)};a.merge=function(){for(var b=[],c=0;c<arguments.length;c++)b[c]=arguments[c];return new a(new B(b))};a.combine=function(){for(var b=[],c=0;c<arguments.length;c++)b[c]=arguments[c];return new a(new E(b))};return a}();h.Stream=g;var p=function(a){function b(b){b=a.call(this,b)||this;b._has=!1;return b}m(b,a);b.prototype._n=function(b){this._v=b;this._has=!0;a.prototype._n.call(this,
...
b)};b.prototype.take=function(b){return a.prototype.take.call(this,b)};b.prototype.endWhen=function(b){return a.prototype.endWhen.call(this,b)};b.prototype.replaceError=function(b){return a.prototype.replaceError.call(this,b)};b.prototype.remember=function(){return this};b.prototype.debug=function(b){return a.prototype.debug.call(this,b)};return b}(g);h.MemoryStream=p;h.default=g},{"symbol-observable":2}],2:[function(g,k,h){var d="undefined"!==typeof global?global:"undefined"!==typeof self?self:"undefined"!==
typeof window?window:{};Object.defineProperty(h,"__esModule",{value:!0});g=(g=g("./ponyfill.js"))&&g.__esModule?g:{"default":g};k="undefined"!==typeof self?self:"undefined"!==typeof window?window:"undefined"!==typeof d?d:"undefined"!==typeof k?k:Function("return this")();k=(0,g["default"])(k);h["default"]=k},{"./ponyfill.js":3}],3:[function(g,k,h){Object.defineProperty(h,"__esModule",{value:!0});h["default"]=function(d){var g=d.Symbol;"function"===typeof g?g.observable?d=g.observable:(d=g("observable"),
g.observable=d):d="@@observable";return d}},{}]},{},[1])(1)});